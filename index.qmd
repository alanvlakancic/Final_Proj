...
## All of your code displays on the published webpage - you can do "code folding" in your yaml - also consider doing "echo = FALSE" (AV)
---
...
#Are there big "spectrum based" ideological differences between the USA and France? For example, is the political spectrum in America different (ie: more right) than France? Are there more political parties? This could actually be beneficial for your project. (AV)
...
#There are some states and cities that do "ranked choice" voting (NYC being one), would this compare well? (AV)

#Are there different definitions of "urban rural"? Will you substitute your own? (AV)
...
#Can you upload it into github, maybe under data folder? This may help? (AV)
...
```
*I haven't accomplish setting a download link for this set of data yet. ##I think you can place this data within the data folder in GitHub rather than accessing it locally. (AV)
...
install.packages("janitor")  # In your presentation, I'd like to know what this one does! (AV)
install.packages("stringr")  # In your presentation, I'd like to know what this one does! (AV)
...
## Are there similarly sized geometries to "Counties" in France? (AV)
